...
try:
    from obfuscation import ContentObfuscator, create_moderate_obfuscator
    ...
    def __init__(self, 
        ...
        if self.enable_obfuscation:
            if obfuscation_config:
                ...
                # Use moderate obfuscation as default
                self.obfuscator = create_moderate_obfuscator()
        else:
...
def test_enhanced_pdf_handler():
    ...
    try:
        ...
        if handler.obfuscator:
            ...
            print(f"   - Page removal probability: {handler.obfuscator.page_removal_prob}")
